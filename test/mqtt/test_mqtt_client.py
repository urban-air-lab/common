...
def test_publish_single():
    ...
    with (
        patch("ual.mqtt.mqtt_client.MQTTClient.publish_data") as mock_publish_data,
...
def test_publish_single_connection_error():
    ...
    with (
        patch(
            "ual.mqtt.mqtt_client.MQTTClient.publish_data", side_effect=ConnectionError
        ),
        patch("ual.mqtt.mqtt_client.get_logger") as mock_get_logger,
